...
public interface ArticleDao extends BaseDao<Article> {
    ...
    List<Article> fuzzyFindByPage(String fuzzyname, Integer bias, Integer start, Integer pageNum);
    ...
    /**
     * 这里是一些专有的查询方法
     * 如：根据标题来模糊查询，查询最受欢迎的文章，根据种类查询最受欢迎文章......
     */
    @Select("select * from tb_article where title like concat('%',#{name},'%')")
    Article findByTitle(@Param("name") String name);
